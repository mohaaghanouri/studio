		...
		cards: [
			{
				...
				text: 'Dentists, therapists, practice owners — appointments handled, office paperwork and scanned documents sorted, session and call recordings turned into clean, readable notes.'
			},
			{
				label: 'Law & finance',
				text: 'Lawyers, tax advisors, financial professionals — long documents read, compared and summarized; files kept in order; the numbers pulled out of a pile of PDFs in minutes.'
			},
			{
				label: 'Science & education',
				text: 'PhD students, professors, teachers — literature reviewed faster, drafts sharpened, teaching materials and exams prepared in a fraction of the time.'
			},
			{
				label: 'Business & marketing',
				text: 'Executives, marketers, product teams — survey answers analyzed, catalogs processed, reports condensed to the decisions that matter.'
			},
			{
				label: 'Personal goals',
				text: 'A well-run job search, preparation for language certificates (IELTS, ÖSD, TELC), or a house hunt with every document checked before you sign.'
			},
			{
				label: 'Learn it yourself',
				text: 'Any profession — I teach you personally, one on one, how to use AI in your own work. No technical background needed, ever.'
			}
		],
